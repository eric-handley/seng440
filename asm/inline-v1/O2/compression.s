...
.LFB4002:
	...
	bls	.L2
	movi	v28.8b, 0xf
	movi	v27.8b, 0xffffffffffffff80
	movi	v31.8h, 0x84
	mov	w0, 0
...
.L3:
	...
	abs	v22.8h, v24.8h
	shrn	v24.8b, v24.8h, 8
	add	v23.8h, v23.8h, v31.8h
	and	v25.8b, v25.8b, v27.8b
	add	v22.8h, v22.8h, v31.8h
	and	v24.8b, v24.8b, v27.8b
	...
	sub	v19.8b, v26.8b, v19.8b
	ushl	v21.8h, v23.8h, v21.8h
	sub	v18.8b, v26.8b, v18.8b
	ushl	v20.8h, v22.8h, v20.8h
	shl	v19.8b, v19.8b, 4
	xtn	v21.8b, v21.8h
	shl	v18.8b, v18.8b, 4
	xtn	v20.8b, v20.8h
	...
	orr	v25.8b, v21.8b, v25.8b
	orr	v24.8b, v20.8b, v24.8b
	orr	v19.8b, v25.8b, v19.8b
	orr	v18.8b, v24.8b, v18.8b
	not	v19.8b, v19.8b
	not	v18.8b, v18.8b
	ins	v19.d[1], v18.d[0]
	str	q19, [x6, w0, uxtw]
